# Condition in python or any programming language is used to make decisions 
...
# 'if conditions' always yakes truthy or falsy statement . If the statement is truthy the block inside if condition is exuceted . 
# If falsy the block inside if is not executed 
...
if age : 
    print(f"The person's age is {a}")
else:
    print("The age is not provide")
